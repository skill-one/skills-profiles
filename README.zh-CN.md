...
- **domain**：9006 个里已标 8928 个（99.1%），覆盖镜像安装量的 100.0%
- **translate**：9006 个里已翻译 8908 个（98.9%），覆盖镜像安装量的 99.9%
- **skill_zh**：9006 个里已有 1361 个中文页面（15.1%），覆盖镜像安装量的 83.7%
- **快照**：`dist-2026-09-24`，2026-09-24T20:52:29Z -> 2026-09-24T21:22:24Z (29m54s)
- **可建**：9028 个里有 9006 个可读出 description；其余的永远不会被构建
