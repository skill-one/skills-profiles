...
通过 [inference.sh](https://inference.sh) CLI，使用 40 多种 AI 模型生成视频。
...
| Veo 3.1 | `google/veo-3-1` | 最高质量，支持帧插值 |
| Veo 3 | `google/veo-3` | 高质量，支持音频 |
| Veo 3 Fast | `google/veo-3-fast` | 快速，支持音频 |
| Veo 2 | `google/veo-2` | 逼真的视频 |
| **P-Video** | `pruna/p-video` | 快速、经济实惠，支持音频 |
| **WAN-T2V** | `pruna/wan-t2v` | 经济实惠的 480p/720p |
| Grok Video | `xai/grok-imagine-video` | xAI，可自定义时长 |
| **Seedance 2.0** | `bytedance/seedance-2-0` | 支持文本、图像、参考视频转视频及同步音频，最高 1080p |
| **Seedance 2.0 Fast** | `bytedance/seedance-2-0-fast` | 快速变体，具备相同功能 |
| **HappyHorse T2V** | `alibaba/happyhorse-1-0-t2v` | 物理逼真，最长 15 秒 |

### 图像转视频

| 模型 | App ID | 适用场景 |
|-------|--------|----------|
| Wan 2.5 | `falai/wan-2-5` | 任意图像动画化 |
| Wan 2.5 I2V | `falai/wan-2-5-i2v` | 高质量 i2v |
| **WAN-I2V** | `pruna/wan-i2v` | 经济实惠的 480p/720p |
| **P-Video** | `pruna/p-video` | 快速 i2v，支持音频 |
| **Seedance 2.0** | `bytedance/seedance-2-0` | 图像动画化，支持同步音频，最高 1080p |
| **Seedance 2.0 Fast** | `bytedance/seedance-2-0-fast` | 快速变体，具备相同功能 |
| **HappyHorse I2V** | `alibaba/happyhorse-1-0-i2v` | 图像动画化，最高 1080P/15s |
| **HappyHorse R2V** | `alibaba/happyhorse-1-0-r2v` | 保留人物特征 |
...
| Fabric 1.0 | `falai/fabric-1-0` | 图像带唇形同步说话 |
| PixVerse Lipsync | `falai/pixverse-lipsync` | 逼真的唇形同步 |
...
| Media Merger | `infsh/media-merger` | 带有转场效果合并视频 |
