...
| 参考 | 描述 |
|-----------|-------------|
| [references/commands.md](references/commands.md) | 完整功能参考及所有选项 |
...
| [references/video-recording.md](references/video-recording.md) | 调试用录制工作流 |
...
- [Multi-function Apps](https://inference.sh/docs/extend/multi-function-apps) - 功能如何工作
