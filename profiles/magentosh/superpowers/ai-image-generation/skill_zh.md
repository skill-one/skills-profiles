...
> 需要使用 inference.sh CLI（`belt`）。安装说明见 [安装说明](https://raw.githubusercontent.com/inference-sh/skills/refs/heads/main/cli-install.md)
...
| 模型 | 应用 ID | 适用场景 |
|-------|--------|----------|
| **GPT-Image-2** | `openai/gpt-image-2` | 文生图、编辑、修复 |
| FLUX Dev LoRA | `falai/flux-dev-lora` | 高质量，支持自定义风格 |
| FLUX.2 Klein LoRA | `falai/flux-2-klein-lora` | 快速生成，支持 LoRA（4B/9B） |
| **P-Image** | `pruna/p-image` | 快速、经济、多种比例 |
| **P-Image-LoRA** | `pruna/p-image-lora` | 快速生成，支持预设 LoRA 风格 |
| **P-Image-Edit** | `pruna/p-image-edit` | 快速图像编辑 |
| Gemini 3 Pro | `google/gemini-3-pro-image-preview` | 谷歌最新模型 |
| Gemini 2.5 Flash | `google/gemini-2-5-flash-image` | 谷歌快速模型 |
| Grok Imagine | `xai/grok-imagine-image` | xAI 模型，多种比例 |
| Seedream 4.5 | `bytedance/seedream-4-5` | 2K-4K 电影级画质 |
| Seedream 4.0 | `bytedance/seedream-4-0` | 高质量 2K-4K |
| Seedream 3.0 | `bytedance/seedream-3-0-t2i` | 准确的文字渲染 |
| Reve | `falai/reve` | 自然语言编辑、文字渲染 |
| ImagineArt 1.5 Pro | `falai/imagine-art-1-5-pro-preview` | 超高分辨率 4K |
| FLUX Klein 4B | `pruna/flux-klein-4b` | 价格超低（$0.0001/张） |
