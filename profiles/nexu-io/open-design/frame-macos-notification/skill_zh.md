【模板: macOS 通知横幅】
【意图】将一段公告 / 消息 / 提示渲染成 macOS Big Sur+ 风格的通知横幅，适合视频角落叠加、产品发布预告、社媒图。灵感来源于 hyperframes macos-notification。
...
- 背景: **磨砂玻璃** 效果 — `background: rgba(245,245,247,0.78)` + `backdrop-filter: blur(40px) saturate(180%)`; 暗色版 `rgba(28,28,30,0.78)`。
...
【内容】
- 左侧: **App 图标** (44×44, 圆角 10px, CSS 渐变 + 1 个 emoji 或 monogram 字母, **不用外链图片**)。
- 中间:
