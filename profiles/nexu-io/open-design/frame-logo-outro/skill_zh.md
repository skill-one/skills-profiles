【模板: Logo 结尾帧 (Logo Outro)】
【意图】视频结尾的品牌 reveal 帧 —— logo 分块拼装 + glow bloom + tagline 上浮 + CTA。受 hyperframes logo-outro 启发。
...
【调色 — 4 选 1, 不混用】
- 🌌 **午夜靛蓝** — bg `#08090c`, accent `#7c5cff` (霓虹紫蓝 glow)。
- 🌅 **日晷琥珀** — bg `#0e0a08`, accent `#ffb547` (暖琥珀)。
- 🌿 **森林薄荷** — bg `#0a1410`, accent `#5fb38a` (薄荷绿)。
- ⚪ **骨白墨影** — bg `#f1efea`, accent `#0a0a0b` (无 neon, 走 editorial 风, glow 改成阴影)。
