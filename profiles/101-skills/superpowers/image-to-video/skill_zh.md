...
belt app run falai/flux-dev-lora --input '{
  "prompt": "日落时分的宁静山湖，雪山倒映在静止的水面，黄金时刻的光线，风景摄影",
  "width": 1248,
  "height": 832
}'
...
| 场景 | 最佳模型 | 原因 |
|----------|-----------|-----|
| 水景带水/云 | **Wan 2.5 i2v** | 最擅长自然、真实的动态 |
| 人像带微妙表情 | **Wan 2.5 i2v** | 保持面部保真度 |
| 产品带布料/织物 | **Fabric 1.0** | 专精于材料物理 |
...
# 人像动画
belt app run falai/wan-2-5-i2v --input '{
  "prompt": "轻微呼吸运动，轻微转头，自然眨眼，头发轻柔移动，柔和环境光变化",
  "image": "portrait.png"
}'
...
# 建筑可视化
belt app run falai/wan-2-5-i2v --input '{
  "prompt": "缓慢前移穿过入口，轻微摄像机向上倾斜，环境光透过窗户，光束中尘埃",
...
belt app run bytedance/seedream-4-5 --input '{
  "prompt": "电影感景观，黎明时分的雾气山脉，前景湖泊，戏剧性云朵，黄金时刻，4K质量，专业摄影",
  "size": "2K"
}'
...
```bash
belt app run falai/wan-2-5-i2v --input '{
  "prompt": "只有瀑布在动，其他一切保持完美静止，水流平稳，场景其他部分冻结",
