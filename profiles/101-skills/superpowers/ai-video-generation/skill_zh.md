...
| Veo 3.1 | `google/veo-3-1` | 最佳画质，支持帧插帧 |
...
| **Seedance 2.0** | `bytedance/seedance-2-0` | 文本/图像/参考素材转视频，支持同步音频，最高 1080p |
...
| **Seedance 2.0** | `bytedance/seedance-2-0` | 动画化图像，支持同步音频，最高 1080p |
| **Seedance 2.0 Fast** | `bytedance/seedance-2-0-fast` | 快速版本，具备相同能力 |
| **HappyHorse I2V** | `alibaba/happyhorse-1-0-i2v` | 动画化图像，最高 1080P/15 秒 |
| **HappyHorse R2V** | `alibaba/happyhorse-1-0-r2v` | 基于参考素材保留角色特征 |
...
| Fabric 1.0 | `falai/fabric-1-0` | 图像与唇形同步对话 |
