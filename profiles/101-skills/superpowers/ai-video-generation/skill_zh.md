...
| **Seedance 2.0** | `bytedance/seedance-2-0` | 文本/图像/参考视频带同步音频，最高 1080p |
...
| Wan 2.5 I2V | `falai/wan-2-5-i2v` | 高画质 i2v |
| **WAN-I2V** | `pruna/wan-i2v` | 经济 480p/720p |
| **P-Video** | `pruna/p-video` | 快速 i2v 带音频 |
| **Seedance 2.0** | `bytedance/seedance-2-0` | 动画化图像带同步音频，最高 1080p |
| **Seedance 2.0 Fast** | `bytedance/seedance-2-0-fast` | 快速变体，相同功能 |
