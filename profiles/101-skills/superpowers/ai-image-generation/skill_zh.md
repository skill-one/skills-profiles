...
通过 [inference.sh](https://inference.sh) CLI 使用 50 多款 AI 模型生成图像。
...
| **P-Image** | `pruna/p-image` | 快速、经济、支持多尺寸 |
...
| Grok Imagine | `xai/grok-imagine-image` | xAI 模型，支持多尺寸 |
...
| ImagineArt 1.5 Pro | `falai/imagine-art-1-5-pro-preview` | 超高清 4K 画质 |
| FLUX Klein 4B | `pruna/flux-klein-4b` | 超经济（每张图像 0.0001 美元） |
