...
> **安装说明**: 如果您从 GitHub 安装此技能，请参考 [README.md](README.md#安装) 获取安装指南。推荐方法为 `npx skills add https://github.com/op7418/Youtube-clipper-skill`。

## 工作流程

您将按照以下 6 个阶段执行 YouTube 视频剪辑任务：
