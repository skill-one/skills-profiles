...
工序心里走透，但**别写进文章**——和判据一样，是内功不是叙事钩子。读者看不到挖的过程，但感得到背后是凿到底的。
...
判据在心里走结实，但**别落到纸上**——不要出现"砍一刀看看""拆一根试试"这种验证动作。这些会打断读者从"乱"到"简"的那一口气。读者看不到验证过程，但感得到底下是硬的。
...
**演示要求**:图里必须标几个具体现象的坐标——比如"拥抱"落在哪、"问候"落在哪、"熵的局部逆转"落在哪。读者一眼看见这框怎么用,才学得会。空有坐标轴没有演示点 = 空摆设。
