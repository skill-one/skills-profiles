...
针对一个项目，撰写一份投资分析报告。整份报告只回答一个问题：这个东西是在创造新秩序，还是在搬运旧秩序。

## 基础概念

一个定义支撑整份报告：财富不是钱，而是被欲望照亮的秩序，钱只是秩序的计量单位。投资，是用手中的秩序，去换取一台更好的秩序生成器。

从这个定义出发，报告的问法和市场惯例不同：
...
公司名称、商业计划书、文字介绍、对话记录，任何描述项目的材料都可以。知名公司只需提供名称即可——使用 Research 技能或 subagent 抓取最新财报和行业数据，不要凭旧印象撰写。

## 报告结构

五个区块是骨架，不是填空题。哪个区块对这个项目最有价值，就多写；没价值的用一两句话带过，或者干脆跳过。报告为判断服务，凑完整没有意义。
...
|----------|----------------------------------------------|
| 项目名称 |                                              |
| 赛道定义 | 用我们自己的话说，不抄袭市场标签               |
| 阶段     |                                              |
| 融资情况 | 金额 / 估值 / 条款（有则填，无则标注）       |
| 数据快照 | 关键运营数据                                 |

赛道定义要说出这家公司真正在做什么——市场标签说不出的那一层。称它为「搜索引擎公司」等于什么都没说；说它是「人类认知基础设施的垄断运营商」，它靠什么赚钱、怕什么，全在这一句里。

### 二、秩序创造机器判定

整份报告的分量都压在这一节。不逐项打分，回答一个问题就足够：**这台机器转不转得起来？** 从三个角度看。
