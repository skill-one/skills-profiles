...
| 时长 | 质量 | 适用于 |
|------|------|--------|
| 2-3秒 | 最高质量 | GIF，循环背景，cinemagraph |
| 4-5秒 | 高质量 | 社交媒体帖子，产品揭示 |
| 6-8秒 | 良好质量 | 短视频，过渡 |
| 10秒以上 | 质量显著下降 | 避免除非拼接短片段 |
...
Cinemagraph 是一张静态照片，其中只有一个元素在运动（例如，冻结场景中的瀑布运动）。要实现这一点：
...
```bash
belt app run falai/wan-2-5-i2v --input '{
  "prompt": "只有瀑布在运动，其他所有元素保持完美静止，水流平稳，场景其他部分冻结",
