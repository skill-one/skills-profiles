...
使用字节跳动 Seedance 2.0 通过 [inference.sh](https://inference.sh) CLI 生成带同步音频的视频。
...
所有模型都支持文本到视频、图像到视频、多模态参考到视频以及同步音频生成。工作室变体会自动将参考图像上传到 BytePlus 私有的虚拟肖像库以增强角色一致性 - 特别适用于面部和品牌角色。
