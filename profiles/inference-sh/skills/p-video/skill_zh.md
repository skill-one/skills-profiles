...
belt app run pruna/p-video --input '{"prompt": "无人机日落时分飞越森林"}'
```
...
| 模型 | 分辨率 | 定价 |
|------|--------|------|
| P-Video | 720p, 1080p | 按秒计费，根据分辨率/草稿不同 |
