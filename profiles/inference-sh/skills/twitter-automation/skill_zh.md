...
# 发布推文
belt app run x/post-create --input '{"text": "来自 inference.sh 的问候！"}'
```
...
| 应用 | 应用 ID | 描述 |
|-----|--------|-------------|
| 创建推文 | `x/post-create` | 发布文本，可选附带媒体 |
...
```bash
belt app run x/post-create --input '{"text": "刚刚发布了一个新功能！ 🚀"}'
```
