...
P-Video-Avatar 是目前最快且最具成本效益的头像视频模型。质量与 Veo 3.0 相当，比 Fabric、OmniHuman 和 HeyGen 等替代方案快 18 倍且便宜 6 倍。
...
| `voice` | 字符串 | "Zephyr (Female)" | 语音选择 |
| `voice_language` | 字符串 | "English (US)" | 输出语言 |
...
**P-Video-Avatar 从 2026 年 5 月 1 日下午 4:00 CET 至 2026 年 5 月 4 日晚上 11:59 CET 完全免费。** 在此窗口期内，所有费用均由我们承担——无账单，无分辨率限制。
