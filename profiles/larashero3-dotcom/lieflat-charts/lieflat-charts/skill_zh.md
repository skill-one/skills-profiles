...
2. **用最接近本体的模板起步**——多选题百分比优先比较 L15、F5、L2；100% 构成优先比较 L14、L5、F4、G4；占比×强度双编码 → G13 Big Slice；按类堆叠 → F7 Stacked Rungs
...
11. 如果是一页多图，模板是否全局分配过？有没有相似轮廓重复、暗卡过量、所有图都变成六张相似的环或横条？
