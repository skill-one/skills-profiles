...
创建美观、可访问的用户界面的综合技能，结合shadcn/ui组件、Tailwind CSS实用样式和基于画布的视觉设计系统。
...
CLI会提示您选择框架、TypeScript、路径和主题偏好。这将配置shadcn/ui和Tailwind CSS。
...
**样式系统**
- `references/tailwind-utilities.md` - 核心实用工具
