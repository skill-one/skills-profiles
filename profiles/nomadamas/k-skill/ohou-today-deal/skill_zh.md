...
<!-- k-skill:cli-stub — 由 scripts/generate-skill-stubs.js 脚本生成；请修改 skill.json / instruction.md 而非此文件 -->
...
如果 `npx` 不可用，请安装 Node.js 18+ 或遵循 https://github.com/NomaDamas/k-skill#readme，或阅读源代码说明 https://github.com/NomaDamas/k-skill/blob/main/ohou-today-deal/instruction.md。
...
在使用前，请阅读完整的韩语法律免责声明，包括引用的韩国最高法院先例和法定限制：
