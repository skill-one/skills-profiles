...
如果 `npx` 不可用，请安装 Node.js 18+ 或遵循 https://github.com/NomaDamas/k-skill#readme，或阅读源代码说明 https://github.com/NomaDamas/k-skill/blob/main/keris-academic-search/instruction.md。
...
- 切勿索要、打印或存储聊天、文件或 shell 参数中的明文凭证。
