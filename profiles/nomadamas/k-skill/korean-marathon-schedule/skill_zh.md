...
CLI 会检测当前运行时环境（Dolshoi vault/CloakBrowser 对比通用环境）并仅打印适用说明，始终保持最新。CLI 随附的辅助文件列表可通过以下命令获取：
...
如果 `npx` 不可用，请安装 Node.js 18+ 或遵循 https://github.com/NomaDamas/k-skill#readme，或阅读源代码说明 https://github.com/NomaDamas/k-skill/blob/main/korean-marathon-schedule/instruction.md。
