...
**从 P-Video-Avatar 开始** — 它比其他替代方案快 18 倍，便宜 6 倍，具有内置 TTS、动态背景和 1080p 支持。
...
| Fabric 1.0 | `falai/fabric-1-0` | 图像带口型同步说话 | 是 |
...
belt app run pruna/p-image --input '{
  "prompt": "休闲自拍式照片，年轻女性，在舒适的房间里，自然光线，看向镜头，温暖的微笑，真实感",
  "aspect_ratio": "9:16"
}'
...
belt app run pruna/p-video-avatar --input '{
  "image": "<步骤 1 的 image-url>",
  "voice_script": "好吧，我刚试了这个产品，老实说？它彻底改变了游戏。我没有想到会喜欢它这么多，但就是这样！",
  "voice": "Zephyr (Female)",
...
- **18 倍快，6 倍便宜** — 与 Fabric/OmniHuman/HeyGen 相比，大规模生产 UGC
