...
世界级高级计算机视觉工程师技能，适用于生产级AI/ML/数据系统。
...
在 `references/computer_vision_architectures.md` 中提供全面指南，涵盖：
...
在 `references/object_detection_optimization.md` 中提供完整工作流文档，包括：
...
在 `references/production_vision_systems.md` 中提供技术参考指南，包含：
