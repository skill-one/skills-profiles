...
在 `references/statistical_methods_advanced.md` 中提供全面指南，涵盖：
...
在 `references/experiment_design_frameworks.md` 中提供完整工作流文档，包括：
...
在 `references/feature_engineering_patterns.md` 中提供技术参考指南，包括：
