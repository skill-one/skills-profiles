...
```
使用bash /path/to/skill/scripts/install-skill.sh vercel-labs/agent-skills@vercel-react-best-practices
...
```
我找到一个可能帮助你的技能！"vercel-react-best-practices"技能提供了来自Vercel工程的React和Next.js性能优化指南。
...
如果用户想继续，使用`install-skill.sh`脚本安装技能并自动将其链接到项目：
...
我仍然可以直接帮助您完成这项任务！您想让我继续吗？

如果这是一个您经常做的事情，您可以创建自己的技能：
