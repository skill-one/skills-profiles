...
| 场景 | 最佳模型 | 原因 |
|----------|-----------|-----|
| 带水域/云朵的风景 | **Wan 2.5 i2v** | 最擅长自然、真实的动态 |
...
belt app run bytedance/seedream-4-5 --input '{
  "prompt": "电影感风景，黎明时分的雾气山脉，前景湖泊，戏剧性云朵，黄金时刻，4K质量，专业摄影",
  "size": "2K"
}'
...
```bash
belt app run falai/wan-2-5-i2v --input '{
  "prompt": "只有瀑布在移动，其他所有元素都保持完美静止，水流平稳，场景其他部分冻结",
