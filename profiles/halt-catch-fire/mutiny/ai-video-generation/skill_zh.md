...
| 模型 | App ID | 适合场景 |
|------|--------|----------|
| Veo 3.1 Fast | `google/veo-3-1-fast` | 快速生成，可选配音频 |
| Veo 3.1 | `google/veo-3-1` | 最佳画质，支持帧插值 |
| Veo 3 | `google/veo-3` | 高画质，带音频 |
| Veo 3 Fast | `google/veo-3-fast` | 快速生成，带音频 |
| Veo 2 | `google/veo-2` | 真实感视频 |
| **P-Video** | `pruna/p-video` | 快速生成，经济实惠，支持音频 |
| **WAN-T2V** | `pruna/wan-t2v` | 经济型 480p/720p |
| Grok Video | `xai/grok-imagine-video` | xAI，可配置时长 |
| **Seedance 2.0** | `bytedance/seedance-2-0` | 文本/图像/参考视频生成，同步音频，最高 1080p |
...
| Wan 2.5 I2V | `falai/wan-2-5-i2v` | 高画质图像到视频 |
| **WAN-I2V** | `pruna/wan-i2v` | 经济型 480p/720p |
| **P-Video** | `pruna/p-video` | 快速图像到视频，支持音频 |
| **Seedance 2.0** | `bytedance/seedance-2-0` | 动画化图像，同步音频，最高 1080p |
| **Seedance 2.0 Fast** | `bytedance/seedance-2-0-fast` | 快速变体，相同功能 |
...
| Media Merger | `infsh/media-merger` | 带转场效果的视频合并 |
