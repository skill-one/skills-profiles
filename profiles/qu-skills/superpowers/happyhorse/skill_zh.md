...
通过 [inference.sh](https://inference.sh) CLI 使用 Alibaba 的 HappyHorse 1.0 模型生成和编辑物理逼真的视频。
...
| 模型 | 应用 ID | 最适合 |
|------|--------|--------|
| T2V | `alibaba/happyhorse-1-0-t2v` | 文本到视频，物理逼真的运动 |
