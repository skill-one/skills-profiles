...
# 功能对比
belt app run exa/search --input '{
  "query": "CompetitorX vs 替代品 功能对比 评价"
}'
...
| 错误 | 问题 | 解决方法 |
|------|------|------|
| 仅看功能 | 错过定位、定价、发展势头 | 使用7层框架 |
| 偏见分析 | 失去信誉 | 诚实地说明竞品优势 |
| 数据过时 | 得出错误结论 | 标记所有研究，每季度更新 |
| 竞品过多 | 分析瘫痪 | 专注于前3-5个直接竞争对手 |
| 没有"所以呢" | 数据没有洞察 | 每个部分都以对您的影响结束 |
| 仅功能对比 | 没有显示定位 | 包括定价、评价、定位图 |
