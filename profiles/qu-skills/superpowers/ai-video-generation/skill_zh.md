...
| Veo 3.1 | `google/veo-3-1` | 画质最佳，支持帧插值 |
| Veo 3 | `google/veo-3` | 高画质，支持音频 |
...
| **Seedance 2.0** | `bytedance/seedance-2-0` | 文本/图像/参考转视频，支持同步音频，最高 1080p |
| **Seedance 2.0 Fast** | `bytedance/seedance-2-0-fast` | 快速版本，具备相同能力 |
...
| **Seedance 2.0 Fast** | `bytedance/seedance-2-0-fast` | 快速版本，具备相同能力 |
| **HappyHorse I2V** | `alibaba/happyhorse-1-0-i2v` | 图像动画化，最高 1080P/15 秒 |
| **HappyHorse R2V** | `alibaba/happyhorse-1-0-r2v` | 保留角色特征的参考视频生成 |
...
| Fabric 1.0 | `falai/fabric-1-0` | 图像说话并同步口型 |
| PixVerse Lipsync | `falai/pixverse-lipsync` | 逼真的口型同步 |
...
- [通过 CLI 运行应用](https://inference.sh/docs/apps/running) - 如何通过 CLI 运行应用
- [流式结果](https://inference.sh/docs/api/sdk/streaming) - 实时进度更新
- [内容工作流示例](https://inference.sh/docs/examples/content-pipeline) - 构建媒体工作流
