...
|-------|--------|----------|
| **GPT-Image-2** | `openai/gpt-image-2` | 文生图、编辑、图像修复 |
| FLUX Dev LoRA | `falai/flux-dev-lora` | 具备高质量与自定义风格 |
| FLUX.2 Klein LoRA | `falai/flux-2-klein-lora` | 支持 LoRA 且运行快速（4B/9B） |
| **P-Image** | `pruna/p-image` | 运行快速、经济高效、支持多画面 |
| **P-Image-LoRA** | `pruna/p-image-lora` | 支持预设 LoRA 风格且运行快速 |
| **P-Image-Edit** | `pruna/p-image-edit` | 快速图像编辑 |
| Gemini 3 Pro | `google/gemini-3-pro-image-preview` | Google 最新推出 |
| Gemini 2.5 Flash | `google/gemini-2-5-flash-image` | Google 快速模型 |
| Grok Imagine | `xai/grok-imagine-image` | xAI 模型，支持多画面 |
| Seedream 4.5 | `bytedance/seedream-4-5` | 2K-4K 电影级画质 |
| Seedream 4.0 | `bytedance/seedream-4-0` | 高质量 2K-4K |
| Seedream 3.0 | `bytedance/seedream-3-0-t2i` | 文本渲染准确 |
...
- [应用概述](https://inference.sh/docs/apps/overview) - 了解应用生态
