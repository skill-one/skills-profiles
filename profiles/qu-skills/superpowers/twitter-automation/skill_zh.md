...
# 发布一条推文
belt app run x/post-tweet --input '{"文本": "Hello from inference.sh!"}'
```
...
```bash
belt app run x/post-tweet --input '{"文本": "刚发布了一个新功能！🚀"}'
```
...
# 2. 携带图片 URL 发布到 Twitter
belt app run x/post-create --input '{
  "文本": "AI-generated art of a sunset 🌅",
...
- [X.com 集成](https://inference.sh/docs/integrations/x) - 配置 Twitter/X 集成
