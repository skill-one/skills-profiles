...
- **arrays.md** - ARSET、ARINSERT、ARSCAN、ARGREP、AROP、带 ARRING 在稀疏索引寻址数组上的环形缓冲区
- **vector-indexes.md** - VECTOR.CREATE、VECTOR.ADD、VECTOR.QUERY 在 Redis 内部通过 redis.vector 进行最近邻搜索
...
- **commands/index-management.md** - 创建、描述、删除索引（包括 XADD 条目上的流索引）、waitIndexing
