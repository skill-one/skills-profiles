...
**从 P-Video-Avatar 开始** — 它比替代方案快 18 倍，便宜 6 倍，内置 TTS、动态背景和 1080p 支持。
...
belt app run pruna/p-image --input '{
  "prompt": "专业头像肖像，年轻女性，中性背景，看向镜头，工作室灯光，照片级真实",
  "aspect_ratio": "9:16"
}'
...
belt app run pruna/p-video-avatar --input '{
  "image": "<步骤 1 的 image-url>",
  "voice_script": "好吧，我刚刚尝试了这个产品，老实说？它彻底改变了游戏规则。我没有想到会喜欢它这么多，但就是这样！",
  "voice": "Zephyr (Female)",
