...
belt app run falai/flux-dev-lora --input '{
  "prompt": "日落时分宁静的山湖，雪山倒映在静止的水面，黄金时刻的光线，风景摄影",
  "width": 1248,
  "height": 832
}'
...
# 风景动画
belt app run falai/wan-2-5-i2v --input '{
  "prompt": "缓慢向右平移，水面倒映着移动的云朵，树木轻微随风摇曳，温暖金色光线，宁静缓慢",
  "image": "landscape.png"
}'
...
belt app run bytedance/seedream-4-5 --input '{
  "prompt": "电影感风景，黎明时分的雾气山脉，前景湖面，戏剧性云朵，黄金时刻，4K质量，专业摄影",
  "size": "2K"
}'
