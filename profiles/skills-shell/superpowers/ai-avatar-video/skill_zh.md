...
**从 P-Video-Avatar 开始** — 它比替代方案快 18 倍，便宜 6 倍，具有内置 TTS、动态背景和 1080p 支持。
...
belt app run bytedance/omnihuman-1-5 --input '{
  ...
  "audio_url": "<步骤 1 中的音频 URL>"
}'
```

> **提示**：对于大多数用例，带有内置 TTS 的 P-Video-Avatar 更简单 — 无需单独的音频步骤。仅在您需要 OmniHuman（多角色）或 PixVerse（逼真口型同步）时使用此工作流程。
...
belt app run pruna/p-video-avatar --input '{
  "image": "<步骤 1 中的图像 URL>",
  "voice_script": "好吧，我刚刚试了这个产品，老实说？它彻底改变了游戏规则。我没有想到会喜欢它这么多，但我们就这样了！",
  "voice": "Zephyr (Female)",
  "voice_prompt": "兴奋、休闲、像和朋友聊天一样的真实语气",
  "video_prompt": "人物在房间里随意地对着镜头说话，自然的手势",
  "resolution": "1080p"
}'
```
...
- **UGC & 营销**：产品演示、UGC 风格的广告，使用 AI 演讲者
- **教育**：课程视频、解释视频
...
- 使用高质量的肖像照片（正面、良好光线）
- 音频应清晰，背景噪音最小
- P-Video-Avatar 支持 内置 TTS — 无需单独的语音生成步骤
