...
| 应用 | 应用 ID | 说明 |
|-----|--------|------|
| Post Tweet | `x/post-tweet` | 发布文字推文 |
| Create Post | `x/post-create` | 发布含媒体内容 |
| Like Post | `x/post-like` | 点赞推文 |
| Retweet | `x/post-retweet` | 转发帖子 |
| Delete Post | `x/post-delete` | 删除推文 |
| Get Post | `x/post-get` | 按 ID 获取推文 |
| Send DM | `x/dm-send` | 发送私信 |
| Follow User | `x/user-follow` | 关注用户 |
| Get User | `x/user-get` | 获取用户资料 |
