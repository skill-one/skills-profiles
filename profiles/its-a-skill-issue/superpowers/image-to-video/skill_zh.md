...
belt app run falai/flux-dev-lora --input '{
  "prompt": "日落时分宁静的山湖，雪山顶峰倒映在平静的水面，黄金时刻的光线，风景摄影",
  "width": 1248,
  "height": 832
}'
...
| **Seedance 2.0** | `bytedance/seedance-2-0` | 最高支持 1080p，同步音频，所有输入类型 | 多功能，高质量 |
...
AI 视频模型在**轻柔、微妙的运动**下效果优于戏剧性动作。请求过多运动会导致失真和伪影。
...
belt app run bytedance/seedance-2-0 --input '{
  "prompt": "缓慢 360 度环绕产品，轻柔聚光灯移动，微妙反射变化，高端产品展示，平滑运动",
  "image": "product.png",
  "generate_audio": true
}'
...
belt app run bytedance/seedream-4-5 --input '{
  "prompt": "电影感风景，黎明时分的雾气山脉，前景湖面，戏剧性云层，黄金时刻，4K 质量，专业摄影",
  "size": "2K"
}'
