...
通过 [inference.sh](https://inference.sh) CLI，使用 50+ 款 AI 模型生成图像。
...
FLUX Dev LoRA | `falai/flux-dev-lora` | 高品质、支持自定义风格 |
FLUX.2 Klein LoRA | `falai/flux-2-klein-lora` | 快速、支持 LoRA（4B/9B） |
**P-Image** | `pruna/p-image` | 快速、经济实惠、支持多种画面比例 |
...
Grok Imagine | `xai/grok-imagine-image` | xAI 模型，支持多种画面比例 |
Seedream 4.5 | `bytedance/seedream-4-5` | 2K-4K 电影级品质 |
Seedream 4.0 | `bytedance/seedream-4-0` | 高品质 2K-4K |
...
FLUX Klein 4B | `pruna/flux-klein-4b` | 超低价（$0.0001/张） |
