...
```bash
belt app run bytedance/seedance-2-0 --input '{
  "prompt": "第一人称视角产品广告。开帧是 Image 1，手拿起产品。相机推近显示细节。使用 Video 1 中的相机移动风格。背景音乐来自 Audio 1。",
...
| `reference_images` | file[] | - | 参考图像，最多 9 个（与 image/end_image 互斥） |
